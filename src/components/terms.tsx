  ...
  return (
    <div className='min-h-screen bg-background text-foreground'>
      <main className='container mx-auto px-4 py-8 max-w-4xl'>
        ...
        <p className='text-muted-foreground mb-6'>Last updated: October 26, 2024</p>
        <p className='mb-8'>
        ...
        <section className='mb-8'>
          ...
          <ul className='list-disc pl-6 space-y-2'>
            ...
            <li>
              <strong>Country</strong> refers to: Madagascar
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
              this Agreement) refers to Kinotio, Antananarivo, MG 101.
            </li>
            <li>
            ...
            <li>
              ...
              use of the Service. This Terms and Conditions agreement has been created with the help
              of the{' '}
              <Link
            ...
            <li>
              <strong>Website</strong> refers to Drowser, accessible from{' '}
              <Link
