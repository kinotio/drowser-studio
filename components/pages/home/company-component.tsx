          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            <div className="space-y-4 text-black">
              ...
              <p className="mx-auto max-w-[700px] md:text-xl">
                Our platform is trusted by some of the biggest names in the
                industry. See how we ve helped them deliver high-quality
                software and stay ahead of the competition.
              </p>
