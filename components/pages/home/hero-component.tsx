          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            <div className="space-y-4 text-white">
              ...
              <p className="mx-auto max-w-[700px] md:text-xl">
                Our powerful platform makes it easy to test your software and
                ensure it meets the highest standards. Streamline your testing
                process and deliver reliable, high-quality applications.
              </p>
